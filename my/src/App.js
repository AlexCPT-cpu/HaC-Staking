      ...
      <div className="App nftapp">
        <nav class="navbar navbarfont navbarglow navbar-expand-md navbar-dark bg-dark mb-4">
          <div class="container-fluid" style={{ fontFamily: "SF Pro Display" }}>
            <a class="navbar-brand px-5" style={{ fontWeight: "800", fontSize: '25px' }} href="#"></a><img src="logo.webp" width="17%" />
            ...
            <body className='nftminter'>
              <form>
                ...
                <div class="card" style={{ marginTop: "3px", boxShadow: "1px 1px 4px #000000"}}>
                  ...
                  <Button onClick={stakeit} className='mb-3' style={{ backgroundColor: "blue", boxShadow: "1px 1px 5px #000000" }} >STAKE</Button>
                  <Button onClick={unstakeit} className='mb-3' style={{ backgroundColor: "blue", boxShadow: "1px 1px 5px #000000" }} > UNSTAKE</Button>
                </div>
              </form>
            </body>
          </div><hr />
                ...
                <div className="row px-3">
                  ...
                  <div className="col">
                    ...
                    <form class="stakingrewards" style={{ borderRadius: "25px", boxShadow: "1px 1px 15px #ffffff" }}>
                      ...
                      <input name="claimid" style={{ color: "#39FF14", fontSize: '25px', fontWeight: 'bold', textShadow: "1px 1px 2px #000000", width: '50px', backgroundColor: '#00000000' }} />
