        ...
        <div className='nftportal mb-4'>
            <div className="container col-lg-11">
              <div className="row items px-3 pt-3">
                <div className="ml-3 mr-3" id='intro'>
                  {apicall.map((nft, i) => {
                    ...
                    return (
                      <div className="card nft-card mt-3 mb-3" key={i} >
                        ...
                        <div className="card-caption row-2 p-0">
                          <div className="card-body">
                            <h6 className="mb-0">HAC 3333  NFT Collection #{nft.tokenId}</h6>
                            <h6 className="mb-0 mt-2">Status<p style={{ color: "#39FF14", fontWeight: "400", textShadow: "1px 1px 2px #000000" }}>Not Staked</p></h6>
                    ...
                    {nftstk.map((nft, i) => {
                      ...
                      return (
                        ...
                        <div className="card stakedcard mt-3 mb-3" key={i} >
                          <div className="image-over">
                          <img style={{position:'absolute',top:'0.05rem',width:'90px'}} src=''></img>
                            <img className="card-img-top" src={nftpng + nft.tokenId + '.png'} alt="" />
                          </div>
                          <div className="card-caption row-2 p-0">
                            <div className="card-body">
                              <h6 className="mb-0">HAC 3333  NFT Collection #{nft.tokenId}</h6>
                              <h6 className="mb-0 mt-2">Status<p style={{ color: "#15F4EE", fontWeight: "400", textShadow: "1px 1px 2px #000000" }}>Currently Staked</p></h6>
                              <div className="card-bottom d-flex justify-content-between">
                                <input key={i} type="hidden" id='stakeid' value={nft.tokenId} />
